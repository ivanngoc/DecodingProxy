...
namespace HttpDecodingProxy.ForHttp
{
    ...
    public class HttpFieldsV11 : IDisposable
    {
        ...
        public HttpFieldsV11()
        {
            ...
            {
                [HttpLibConstants.FieldNames.NAME_CONNECTION] = null,
            };
        ...
        */
        ...
        public bool TryFindTearDown(out string tearDown)
        {
            ...
            {
                if (line.Contains(HttpLibConstants.Fields.FIELD_CONNECTION_CLOSE, StringComparison.InvariantCultureIgnoreCase))
                {
                    tearDown = line;
                    return true;
                }
        ...
        public bool TryFindContentLengthLine(out string contentLength)
        {
            foreach (var line in lines)
            {
                if (line.Contains(HttpLibConstants.FieldSubstrings.SUBSTRING_CONTENT_LENGTH, StringComparison.InvariantCultureIgnoreCase))
                {
                    contentLength = line;
                    return true;
                }
        ...
        public void ParseLines()
        {
            ...
            if (IsResponse)
            {
                ...
                if (IsStatusCodeRange(HttpLibConstants.StatusCodes.SUCCESSFUL_200))
                {
        ...
        {
            bool res = TransferEncodingValues.Last().Contains(HttpLibConstants.FieldValues.VALUE_CHUNKED.ToLowerInvariant());
#if DEBUG
