...
using ManagerConnectionsToDomainSsl = IziHardGames.Libs.ObjectsManagment.ManagerBase<string, IziHardGames.Proxy.Tcp.Tls.ConnectionsToDomainSsl<IziHardGames.Libs.Networking.Pipelines.TcpClientPipedSsl>, (string, int)>;
using HttpPipedIntermediarySsl = IziHardGames.Proxy.Sniffing.ForHttp.HttpPipedIntermediary<IziHardGames.Proxy.Tcp.Tls.ConnectionsToDomainSsl<IziHardGames.Libs.Networking.Pipelines.TcpClientPipedSsl>, IziHardGames.Libs.Networking.Pipelines.TcpClientPipedSsl>;
